...
class OffreDeSoumission {
  static getAllOffresDeSoumission(callback) {
    db.query('SELECT r.* , p.nom as "participant", a.nom as "offre" from retrait_cahier_de_charge r join participant p on p.id_participant = r.participant_id join appel_offre a on a.id_appel = r.id_appof', callback);
  }
