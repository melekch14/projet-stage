...
exports.createVocation = (req, res) => {
  const { code_vocation, label, secteur, superficie } = req.body;
  const newVocation = { code_vocation, label, secteur, superficie };
...
exports.updateVocation = (req, res) => {
  const id = req.params.id;
  const { code_vocation, label, secteur, superficie } = req.body;
  const updatedVocation = { code_vocation, label, secteur, superficie };
